"""[CREA][synthese] re-add addtional data to synthese for web app view

Revision ID: 5737087f8ee0
Revises: 04afdcd0e42a
Create Date: 2025-08-11 12:20:51.546933
...
def upgrade():
    ...
    op.execute(
        """
CREATE VIEW gn_synthese.v_synthese_for_web_app
