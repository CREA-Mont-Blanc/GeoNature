"""[CREA] add observers_id in synthese for occtax releves

Revision ID: 3685b3cb1837
Revises: 43ecf0836b4a
Create Date: 2024-01-02 16:33:14.105529
...
revision = "3685b3cb1837"
down_revision = None
branch_labels = ("crea-occtax",)
depends_on = "e170d1902137"
...
def upgrade():
    op.execute(
        ...
        CREATE OR REPLACE FUNCTION pr_occtax.insert_in_synthese(my_id_counting integer)
            ...
            VALUES(
                ...
                occurrence.comment,
                'I',
                COALESCE(releve.additional_fields, '{}'::jsonb) || COALESCE(occurrence.additional_fields, '{}'::jsonb) || COALESCE(new_count.additional_fields, '{}'::jsonb) || jsonb_build_object( 'ids_observers', myobservers.observers_id)
            );
    ...
    op.execute(
        ...
        UPDATE gn_synthese.synthese s SET
            ...
            additional_data = COALESCE(NEW.additional_fields, '{}'::jsonb) || COALESCE(o.additional_fields, '{}'::jsonb) || COALESCE(c.additional_fields, '{}'::jsonb) || jsonb_build_object( 'ids_observers', myobservers.observers_id)
        ...
        CREATE OR REPLACE FUNCTION pr_occtax.fct_tri_synthese_update_occ()
            ...
            BEGIN
                ...
                UPDATE gn_synthese.synthese s SET
                    ...
                    additional_data = COALESCE(releve_add_fields, '{}'::jsonb) || COALESCE(NEW.additional_fields, '{}'::jsonb) || COALESCE(c.additional_fields, '{}'::jsonb)  || jsonb_build_object( 'ids_observers', myobservers.observers_id)
                FROM pr_occtax.cor_counting_occtax c
    ...
    CREATE OR REPLACE FUNCTION pr_occtax.fct_tri_synthese_update_counting()
        ...
        BEGIN
            ...
            last_action = 'U',
            --CHAMPS ADDITIONNELS OCCTAX
            additional_data = COALESCE(releve.additional_fields, '{}'::jsonb) || COALESCE(occurrence.additional_fields, '{}'::jsonb) || COALESCE(NEW.additional_fields, '{}'::jsonb) || jsonb_build_object( 'ids_observers', myobservers.observers_id)
    ...
    CREATE OR REPLACE FUNCTION pr_occtax.fct_tri_synthese_update_cor_role_releve()
        ...
        BEGIN
            ...
            SET
                additional_data = COALESCE(additional_data, '{}'::jsonb) || jsonb_build_object( 'ids_observers', myobservers.observers_id)
